            ...
            <form action="{{ route('comics.update', ['comic' => $comic->id]) }}" method="post">
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="title" id="title" placeholder="The Killing Joke"
                        class="form-control @error('title') is-invalid @enderror" value="{{ $comic->title }}" required>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="price" id="price" placeholder="$19.99"
                        class="form-control @error('price') is-invalid @enderror" value="{{ $comic->price }}" required>
                </div>
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="sale_date" id="sale_date" placeholder="2024-02-17"
                ...
                <div class="form-group mb-3">
                    ...
                    <input type="text" name="type" id="type"
                        class="form-control @error('type') is-invalid @enderror" placeholder="Comic Book"
                        value="{{ $comic->type }}" required>
                </div>

                <div class="form-group mb-3">
                    <label for="artists" class="label-control mb-2">ARTISTS:</label>
                    <input artists="text" name="artists" id="type"
